...
export const metadata: Metadata = {
  title: "IT Consulting Services | Technioz",
  description: "Strategic IT consulting and digital transformation. We align technology investments with business goals and growth.",
  openGraph: {
  title: "IT Consulting Services | Strategy & Digital Transformation | Technioz",
    description:
