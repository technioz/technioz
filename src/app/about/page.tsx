    ...
    <>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-[80px]">
            <div className="flex-1 flex flex-col gap-[24px]">
              ...
              <p className="p3 text-black-400 max-w-[600px]">
                Founded in 2024, Technioz is a new-age software company with a passionate team of experts across logistics, e-learning, e-commerce, fintech, custom app development, and more. We help businesses turn ideas into reality with innovative, reliable, and scalable solutions.
              </p>
      ...
      <section className="bg-white-200">
        <div className="max-w-[1440px] mx-auto px-6 py-16 lg:px-[148px] lg:py-[100px] flex flex-col gap-[24px]">
          ...
          <div className="max-w-[800px] flex flex-col gap-6">
            ...
            <p className="p3 text-black-400">
              As a new company, we are driven by curiosity, creativity, and a relentless desire to help our clients succeed. We believe that every business, no matter its size, deserves access to world-class technology and a partner who truly cares.
            </p>
            <p className="p3 text-black-400">
      ...
      <section className="bg-black-500">
        <div className="max-w-[1440px] mx-auto px-6 py-16 lg:px-[148px] lg:py-[100px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { value: "10+", label: "Projects Delivered", sub: "Successfully completed projects in logistics, e-learning, fintech, and more" },
              { value: "100%", label: "Client Focus", sub: "Every project is a partnership — your success is our priority" },
              { value: "10+", label: "Team Members", sub: "A passionate, multi-disciplinary team ready to take on new challenges" },
            ].map((s) => (
      ...
      <section className="bg-cobolt-500">
        <div className="max-w-[1440px] mx-auto px-6 py-16 lg:px-[148px] lg:py-[100px] text-center flex flex-col items-center gap-[24px]">
          <h2 className="h3 !text-white-100">Ready to Start Your Journey With Us?</h2>
          <p className="p3 text-white-100/80 max-w-[600px]">Partner with a passionate team dedicated to building innovative solutions for your business.</p>
          <div className="flex items-center gap-[8px]">
