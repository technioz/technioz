    ...
    "@graph": [
      {
        ...
        logo: "/logo.webp",
        description:
          "Full-cycle software development company. One partner for web, mobile, AI, and cloud. 200+ projects shipped, 50+ engineers, 98% on-time delivery.",
        ...
        sameAs: [
          "https://www.twitter.com/technioz",
